...
<p class="container2">語彙数：{{$part[1]}} word</p>
...
<p class="container2">語彙数：{{$part[2]}} word</p>
...
<p class="container2">語彙数：{{$part[3]}} word</p>
</div>
...
<p class="container2">語彙数：{{$part[4]}} word</p>
</div>
...
<p class="container2">語彙数：{{$part[5]}} word</p>
</div>
...
<p class="container2">語彙数：{{$part[6]}} word</p>
</div>
</div>
