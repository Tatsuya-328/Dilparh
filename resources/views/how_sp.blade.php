...
<!--切り替えボタン-->
              ...
              <a href="{{ route('how') }}">
                ...
                <div class="swich2">
                <a href="{{ route('how_sp') }}">
                    <input type="image" name="test" src="{{ asset('image/howto_sp2.png') }}"
                    onmouseover="this.src='{{ asset('image/howto_sp2.png') }}'"
                    onmouseout="this.src='{{ asset('image/howto_sp2.png') }}'" />
                </a>
           
                </div>

              </div>
  <p class="device">ー For sp ー</p>


  <!--説明2カラム-->
              <div class="contents1 wrapper">
                <img class="howto_image2" src="{{ asset('image/sp1.png') }}">
              ...
              <div class="contents1 wrapper">
                <img class="howto_image2" src="{{ asset('image/sp2.png') }}">
              ...
              <div class="contents1 wrapper">
                <img class="howto_image2" src="{{ asset('image/sp3.png') }}">
              ...
              <div class="contents1 wrapper">
                <img class="howto_image2" src="{{ asset('image/sp4.png') }}">
              ...
              <div class="contents1 wrapper">
                <img class="howto_image2" src="{{ asset('image/sp5.png') }}">
              ...
              <div class="contents1 wrapper">
                <img class="howto_image2" src="{{ asset('image/sp6.png') }}">

                <aside>
                  <h1 class="step">STEP 6</h1>
              <p class="contents1_text">
